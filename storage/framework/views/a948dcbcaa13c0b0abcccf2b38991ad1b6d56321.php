              ...
              <div class="box">
                  ...
                  <div class="content py-3">
                      ...
                      <?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($value != ""): ?>
                         <li class="list-group-item"><b><?php echo e($key); ?>:</b> <?php echo e($value); ?></li>
                         <?php endif; ?>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    <br/>
                     <h3>Metodo di Spedizione</h3>
                       <p><b>Metodo di spedizione scelto:</b> <?php echo e($shipping["shipping"]); ?></p>
                       <br/>
                      <h3>Metodo di Pagamento</h3>
                       <p><b>Metodo di pagamento scelto:</b> <?php echo e($payment["payment"]); ?></p>
