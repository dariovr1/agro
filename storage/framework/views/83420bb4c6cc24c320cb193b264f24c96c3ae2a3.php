                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4  <?php if($errors->has('piva')): ?> errors-label <?php endif; ?>" type="text" name="piva" value="<?php echo e(old('piva')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4  <?php if($errors->has('codfiscale')): ?> errors-label <?php endif; ?>" type="text" name="codfiscale" value="<?php echo e(old('codfiscale')); ?>">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4 <?php if($errors->has('ragsoc')): ?> errors-label <?php endif; ?>" type="text" name="ragsoc" value="<?php echo e(old('ragsoc')); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                   ...
                                   <input class="input--style-4 <?php if($errors->has('paese')): ?> errors-label <?php endif; ?>" type="text" name="paese" value="<?php echo e(old('paese')); ?>" list="paese_list" />
